...
import { PatchNicknameRequestDto } from 'src/interfaces/request/user';
import PatchProfileImageRequestDto from 'src/interfaces/request/user/patch-profile-image.request.dto';
...
const API_DOMAIN = 'http://3.39.240.154:4040/api/v1'; // was 터미널에 publicIPs로 바꾸기
...
const UPLOAD_FILE = () =>'http://3.39.240.154:4040/file/upload';  // was 터미널에 publicIPs로 바꾸기
